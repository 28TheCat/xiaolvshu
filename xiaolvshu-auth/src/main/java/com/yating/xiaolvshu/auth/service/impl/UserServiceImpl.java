...
import com.yating.xiaolvshu.auth.constant.RoleConstants;
import com.yating.xiaolvshu.auth.domain.dataobject.UserDO;
import com.yating.xiaolvshu.auth.domain.dataobject.UserRoleDO;
import com.yating.xiaolvshu.auth.domain.mapper.UserDOMapper;
import com.yating.xiaolvshu.auth.domain.mapper.UserRoleDOMapper;
import com.yating.xiaolvshu.auth.enums.DeletedEnum;
import com.yating.xiaolvshu.auth.enums.LoginTypeEnum;
import com.yating.xiaolvshu.auth.enums.ResponseCodeEnum;
import com.yating.xiaolvshu.auth.enums.StatusEnum;
import com.yating.xiaolvshu.auth.model.vo.user.UserLoginReqVO;
import com.yating.xiaolvshu.auth.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public Long registerUser(String phone) {
        // 获取全局自增的小绿书 ID
        Long xiaolvshuId = redisTemplate.opsForValue().increment(RedisKeyConstants.XIAOLVSHU_ID_GENERATOR_KEY);
